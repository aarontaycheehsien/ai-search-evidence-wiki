...
- [AI search and extraction tools can reduce initial search or screening effort, but measured efficiency gains may coincide with lower retrieval sensitivity or be offset by prompt development, screening, and human verification.](assistant-007.md) — **provisional**
- [In a small qualitative study of researchers using AI discovery and synthesis tools, opaque provenance and confident outputs prompted compensatory source verification and context-dependent trust.](assistant-008.md) — **provisional**
- [One student survey reported higher satisfaction with traditional search engines than generative AI, with substantial variation by student group and frequency of use.](assistant-009.md) — **provisional**
- [A single-library analytics study found that generative AI referrals concentrated on repository content, especially theses and dissertations; referral counts do not establish retrieval quality or user intent.](assistant-010.md) — **provisional**
...
- [Reported citation-fidelity rates for LLM-generated scientific syntheses are sensitive to the evaluation protocol, so comparisons require the same unit of analysis, support rubric, verifier, and source-access procedure.](citation-002.md) — **provisional**
...
- [Agreement between extraction models can identify a more accurate subset of outputs, but neither initial agreement nor agreement reached through cross-critique guarantees correctness.](extraction-006.md) — **supported**
